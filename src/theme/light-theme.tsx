...
import {
    ...
    sb_dark_blue,
    sb_dark_blue_25,
    sb_dark_blue_50, selectedOpacity,
    white
...
import {
    CheckedCheckboxIcon, CheckedRadioIcon, ChevronDownIcon,
    IndeterminateCheckboxIcon,
    SquareErrorIcon,
    SquareInfoIcon,
    SquareSuccessIcon,
    SquareWarningIcon, UncheckedCheckboxIcon, UncheckedRadioIcon
} from "@src/icons";
...
const focusShadow = (color: string) => `0px 0px 0px 3px ${alpha(color, backgroundOpacity)}`
    ...
    components: {
        ...
        MuiRadio: {
            ...
            defaultProps: {
                disableRipple: true,
                size: 'small',
                icon: <UncheckedRadioIcon sx={{height: 18, width: 18, color: 'divider'}}/>,
                checkedIcon: <CheckedRadioIcon sx={{height: 18, width: 18, color: 'primary.main'}}/>,
            },
        },
        MuiCheckbox: {
            styleOverrides: {
            ...
            defaultProps: {
                size: 'small',
                disableRipple: true,
                icon: <UncheckedCheckboxIcon sx={{height: 16, width: 16, color: 'divider'}}/>,
                checkedIcon: <CheckedCheckboxIcon sx={{height: 16, width: 16, color: 'primary.main'}}/>,
                indeterminateIcon: <IndeterminateCheckboxIcon sx={{height: 16, width: 16, color: 'primary.main',}}/>,
            },
        },
        MuiLink: {
            styleOverrides: {
        ...
        MuiSelect: {
            ...
            defaultProps: {
                IconComponent: () => <ChevronDownIcon sx={{
                    position: 'absolute',
                    right: 0,
                    m: 2,
                    pointerEvents: 'none',
        ...
        MuiMenuItem: {
            styleOverrides: {
                root: {
                    '&.Mui-selected': {
                        backgroundColor: alpha(sb_dark_blue, palette.action.selectedOpacity),
                        '&:hover': {
